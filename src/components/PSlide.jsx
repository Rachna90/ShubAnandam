...
import pImg1 from '/images/floorOne.jpg';
import pImg2 from '/images/floorTwo.jpg';
import pImg3 from '/images/floorThree.jpg';
...
const PSlide = () => {
  ...
  useEffect(() => {
    if (swiperInstance && prevRef.current && nextRef.current) {
      ...
      swiperInstance.navigation.destroy(); // destroy first to prevent duplication
  ...
  return (
    <div className="w-full mx-auto lg:my-10">
